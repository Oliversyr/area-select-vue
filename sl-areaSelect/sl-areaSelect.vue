<template>
    <div class="selectArea">
        <el-input size="small" v-model="theArea" name="areasel"
        ...
        <div class="areaContainer" v-if="showArea" @click.stop="stop($event)">
...
//                    this.areaTab = 'city';
                    ...
                    this.showArea = false;
                    this.theArea = this.district ? `${this.areaList[this.province]}-${this.areaList[this.city]}-${this.areaList[this.district]}` : `${this.areaList[this.province]}-${this.areaList[this.city]}`;
                    this.$emit('getAreaId', this.district ? this.district : this.city);
                }
            },
